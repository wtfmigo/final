        ...
        <div class="flex flex-col items-center w-full gap-6 xl:flex-row">
          ...
          <div class="order-3 xl:order-2">
            ...
            >
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">Dasmarinas, philipines</p>
            </div>
          </div>
          <div class="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
            <a
              href="https://www.facebook.com/TylerTheCreator"
              target="_blank"
              rel="noopener"
              class="social-button"
            >
            ...
            <a href="https://x.com/tylerthecreator" target="_blank" rel="noopener" class="social-button">
              <svg
                class="fill-current"
                width="20"
                height="20"
              ...
              <div>
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div>
                    ...
                    <input
                      type="text"
                      value="https://www.facebook.com/TylerTheCreator"
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value="https://x.com/tylerthecreator"
                      class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value="https://www.instagram.com/feliciathegoat/"
                      class="dark:bg-dark-900 h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800"
                    />
                  </div>
                </div>
